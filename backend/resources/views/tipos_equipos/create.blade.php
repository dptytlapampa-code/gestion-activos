...
@section('content')
    <div class="max-w-3xl">
        ...
        <form method="POST" action="{{ route('tipos-equipos.store') }}" class="space-y-6 rounded-2xl border border-surface-200 bg-white p-6 shadow-sm">
            @csrf
            ...
            <div class="flex items-center gap-3">
                <button type="submit" class="rounded-xl bg-primary-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-primary-700">Guardar tipo</button>
