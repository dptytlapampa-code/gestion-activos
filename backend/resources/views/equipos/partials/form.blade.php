...
>
    <div class="border-b border-slate-200 px-6 py-5 sm:px-8">
        ...
        <p class="mt-1 text-sm text-slate-600">Complete la informaciÃ³n solicitada para registrar el equipo en inventario hospitalario.</p>
    </div>
    ...
    >
        ...
        <section class="space-y-4" aria-labelledby="ubicacion-heading">
            <h4 id="ubicacion-heading" class="text-sm font-semibold uppercase tracking-wide text-slate-700">UbicaciÃ³n</h4>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                >
                    <label for="institution_id" class="block text-sm font-medium text-slate-700">InstituciÃ³n <span class="text-red-600" aria-hidden="true">*</span></label>
                    <x-autocomplete
                        name="institution_id"
        ...
        <section class="space-y-4" aria-labelledby="datos-tecnicos-heading">
            <h4 id="datos-tecnicos-heading" class="text-sm font-semibold uppercase tracking-wide text-slate-700">Datos tÃ©cnicos</h4>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    <label for="numero_serie" class="block text-sm font-medium text-slate-700">NÃºmero de serie <span class="text-red-600" aria-hidden="true">*</span></label>
                    <input id="numero_serie" name="numero_serie" type="text" value="{{ old('numero_serie', $equipo?->numero_serie) }}" class="mt-1 w-full rounded-lg border bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus-border-primary-theme focus:outline-none focus:ring-2 focus-ring-primary-theme @error('numero_serie') border-red-400 focus:border-red-500 focus:ring-red-100 @else border-slate-300 @enderror" aria-invalid="@error('numero_serie') true @else false @enderror" aria-describedby="@error('numero_serie') numero_serie_error @enderror" required />
                    @error('numero_serie')
        ...
        <div class="flex flex-col-reverse gap-3 border-t border-slate-200 pt-5 sm:flex-row sm:justify-end">
            ...
            <button
                type="submit"
                class="inline-flex items-center justify-center gap-2 rounded-lg bg-primary-theme px-4 py-2 text-sm font-semibold text-white transition hover-bg-primary-theme focus:outline-none focus:ring-2 focus-ring-primary-theme disabled:cursor-not-allowed disabled:opacity-70"
            ...
            >
                ...
                <span x-text="isSubmitting ? 'Guardandoâ€¦' : '{{ $submit_label ?? 'Guardar equipo' }}'"></span>
            </button>
        </div>
    </form>
</div>
