    ...
    @can('update', $equipo)
        <div class="rounded-xl border border-slate-200 bg-white p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-slate-900">Movimientos del equipo</h3>
                    <p class="mt-1 text-sm text-slate-500">Registre transferencias internas/externas, préstamos y devoluciones desde el formulario dedicado.</p>
                </div>
                <a href="{{ route('movimientos.create', ['equipo_id' => $equipo->id]) }}" class="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-indigo-700">Movimiento / Transferir</a>
            </div>
        </div>
    @endcan
