...
<body class="min-h-screen bg-slate-50 text-slate-800">
    @php
        $navItemBase = 'flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-indigo-600 transition';
    @endphp

    <div class="flex min-h-screen gap-6 p-6">
        <aside class="flex w-64 flex-col rounded-2xl bg-indigo-700 p-4 text-indigo-100 shadow-sm">
            <div class="px-4 py-3">
                <h1 class="text-lg font-semibold tracking-tight text-white">{{ config('app.name') }}</h1>
                <p class="mt-1 text-xs text-indigo-200">Panel administrativo</p>
            </div>

            <nav class="mt-4 flex-1 space-y-1.5">
                <a href="{{ route('dashboard') }}" class="{{ $navItemBase }} {{ request()->routeIs('dashboard') ? 'bg-indigo-600 text-white' : 'text-indigo-100' }}">
                ...
                @if (auth()->user()->hasRole(\App\Models\User::ROLE_SUPERADMIN, \App\Models\User::ROLE_ADMIN))
                    <a href="{{ route('institutions.index') }}" class="{{ $navItemBase }} {{ request()->routeIs('institutions.*') ? 'bg-indigo-600 text-white' : 'text-indigo-100' }}">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                @if (auth()->user()->hasRole(\App\Models\User::ROLE_SUPERADMIN, \App\Models\User::ROLE_ADMIN, \App\Models\User::ROLE_TECNICO))
                    <a href="{{ route('services.index') }}" class="{{ $navItemBase }} {{ request()->routeIs('services.*') ? 'bg-indigo-600 text-white' : 'text-indigo-100' }}">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                @if (auth()->user()->hasRole(\App\Models\User::ROLE_SUPERADMIN, \App\Models\User::ROLE_ADMIN, \App\Models\User::ROLE_TECNICO))
                    <a href="{{ route('offices.index') }}" class="{{ $navItemBase }} {{ request()->routeIs('offices.*') ? 'bg-indigo-600 text-white' : 'text-indigo-100' }}">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                @if (auth()->user()->hasRole(\App\Models\User::ROLE_SUPERADMIN, \App\Models\User::ROLE_ADMIN, \App\Models\User::ROLE_TECNICO, \App\Models\User::ROLE_VIEWER))
                    <a href="{{ route('tipos-equipos.index') }}" class="{{ $navItemBase }} {{ request()->routeIs('tipos-equipos.*') ? 'bg-indigo-600 text-white' : 'text-indigo-100' }}">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                @can('viewAny', \App\Models\Equipo::class)
                    <a href="{{ route('equipos.index') }}" class="{{ $navItemBase }} {{ request()->routeIs('equipos.*') ? 'bg-indigo-600 text-white' : 'text-indigo-100' }}">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                @if (auth()->user()->hasRole(\App\Models\User::ROLE_SUPERADMIN, \App\Models\User::ROLE_ADMIN, \App\Models\User::ROLE_TECNICO, \App\Models\User::ROLE_VIEWER))
                    <a href="{{ route('actas.index') }}" class="{{ $navItemBase }} {{ request()->routeIs('actas.*') ? 'bg-indigo-600 text-white' : 'text-indigo-100' }}">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                @if (auth()->user()->hasRole(\App\Models\User::ROLE_SUPERADMIN))
                    <a href="{{ route('admin.users.index') }}" class="{{ $navItemBase }} {{ request()->routeIs('admin.users.*') ? 'bg-indigo-600 text-white' : 'text-indigo-100' }}">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    ...
                    <a href="{{ route('admin.audit.index') }}" class="{{ $navItemBase }} {{ request()->routeIs('admin.audit.*') ? 'bg-indigo-600 text-white' : 'text-indigo-100' }}">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
