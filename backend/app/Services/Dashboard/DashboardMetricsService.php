...
class DashboardMetricsService
{
     ...
     */
    public function metricsFor(Request $request): array
    {
        $user = $request->user();
     ...
     */
    private function globalAdministrationScopeIds(?User $user): ?array
    {
        return $this->activeInstitutionContext->globalAdministrationScopeIds($user);
    }

    private function operatesWithGlobalScope(?User $user): bool
    {
