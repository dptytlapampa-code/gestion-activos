...
class ServicePolicy
{
    ...
    public function view(User $user, Service $service): bool { return app(ActiveInstitutionContext::class)->isActiveInstitution($user, $service->institution_id); }
    public function create(User $user): bool { return $user->hasRole(User::ROLE_SUPERADMIN, User::ROLE_ADMIN); }
    public function update(User $user, Service $service): bool { return $user->hasRole(User::ROLE_SUPERADMIN, User::ROLE_ADMIN) && app(ActiveInstitutionContext::class)->isActiveInstitution($user, $service->institution_id); }
